$PBExportHeader$common_orca_win32.sru
$PBExportComments$(PB70Base) - Common ORCA Routines for Win32
forward
global type common_orca_win32 from common_orca
end type
end forward

global type common_orca_win32 from common_orca
end type
global common_orca_win32 common_orca_win32
...
long ll_start, ll_start2, ll_end, ll_end2, ll_findrow
...
on common_orca_win32.create
call super::create
end on

on common_orca_win32.destroy
call super::destroy
end on
