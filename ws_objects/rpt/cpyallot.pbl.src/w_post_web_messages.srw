$PBExportHeader$w_post_web_messages.srw
forward
global type w_post_web_messages from w_response
end type
type cb_clear from commandbutton within w_post_web_messages
end type
type pb_find from picturebutton within w_post_web_messages
end type
type cb_new from commandbutton within w_post_web_messages
end type
type dw_sp9_messages from u_pics_dw within w_post_web_messages
end type
type cb_exit from commandbutton within w_post_web_messages
end type
type cb_update from commandbutton within w_post_web_messages
end type
end forward
...
global w_post_web_messages w_post_web_messages
...
on w_post_web_messages.destroy
call super::destroy
...
if SqlServerOracleTrans.of_isconnected()=false  then
...
event clicked;int row_num, li_mesid
string ls_mesid
...
dw_sp9_messages.object.create_date[row_num]=datetime(Today(),time('00:00:00'))
ls_mesid=mid(string(year(Today())),3,2)+string(wf_calc_max_msgid())
li_mesid=long(ls_mesid)
dw_sp9_messages.object.messageid[row_num]=li_mesid
