$PBExportHeader$w_ca_load_deflib.srw
forward
global type w_ca_load_deflib from w_main
end type
type st_7 from statictext within w_ca_load_deflib
end type
type cb_update from commandbutton within w_ca_load_deflib
end type
type st_6 from statictext within w_ca_load_deflib
end type
type st_5 from statictext within w_ca_load_deflib
end type
type st_3 from statictext within w_ca_load_deflib
end type
type st_4 from statictext within w_ca_load_deflib
end type
type cb_retrieve from commandbutton within w_ca_load_deflib
end type
type cbx_libdef from checkbox within w_ca_load_deflib
end type
type sle_rows_upd from singlelineedit within w_ca_load_deflib
end type
type st_2 from statictext within w_ca_load_deflib
end type
type sle_rows from singlelineedit within w_ca_load_deflib
end type
type st_1 from statictext within w_ca_load_deflib
end type
type cb_extract from commandbutton within w_ca_load_deflib
end type
type uo_progress from u_progressbar within w_ca_load_deflib
end type
type cb_oracle from commandbutton within w_ca_load_deflib
end type
type cb_cancel from commandbutton within w_ca_load_deflib
end type
type dw_sp9_deflib from u_pics_dw within w_ca_load_deflib
end type
type dw_ca_def_casub from u_pics_dw within w_ca_load_deflib
end type
end forward
...
global w_ca_load_deflib w_ca_load_deflib
		...
		IF ll_rows_reminder > 0 THEN	
			...
			FOR lcnt = 1 TO 32763
				...
				IF MOD(lcnt,3) <> 0 THEN
					llibcd 		= trim(dw_ca_def_casub.object.libcd[lcnt])
					...
					IF ldefdt = null_date THEN
						ldt_defdt = DateTime(today(),time('00:00:00'))
					ELSE
						ldt_defdt = ldefdt
					END IF					 
...
event updatestart;call super::updatestart;openwithparm(w_pics_retrieve_msg_box,"Updating deflib table in RS21n, Please wait...")
