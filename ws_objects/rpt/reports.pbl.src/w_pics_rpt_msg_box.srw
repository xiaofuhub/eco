$PBExportHeader$w_pics_rpt_msg_box.srw
forward
global type w_pics_rpt_msg_box from w_popup
end type
type sle_retrieve from u_sle within w_pics_rpt_msg_box
end type
end forward
...
global w_pics_rpt_msg_box w_pics_rpt_msg_box

on w_pics_rpt_msg_box.create
int iCurrent
call super::create
