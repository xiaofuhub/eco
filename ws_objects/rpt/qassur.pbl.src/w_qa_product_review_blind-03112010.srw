$PBExportHeader$w_qa_product_review_blind-03112010.srw
forward
global type w_qa_product_review_blind-03112010 from w_sheet
end type
type cb_add_row from commandbutton within w_qa_product_review_blind-03112010
end type
type mle_comments from uo_mle within w_qa_product_review_blind-03112010
end type
type cb_spell from commandbutton within w_qa_product_review_blind-03112010
end type
type cb_updateweb from u_cb within w_qa_product_review_blind-03112010
end type
type cb_add_narr from u_cb within w_qa_product_review_blind-03112010
end type
type cb_comments from u_cb within w_qa_product_review_blind-03112010
end type
type st_4 from statictext within w_qa_product_review_blind-03112010
end type
type cb_find from u_cb within w_qa_product_review_blind-03112010
end type
type cb_exit from u_cb within w_qa_product_review_blind-03112010
end type
type cb_clear from u_cb within w_qa_product_review_blind-03112010
end type
type cb_update from u_cb within w_qa_product_review_blind-03112010
end type
type st_1 from statictext within w_qa_product_review_blind-03112010
end type
type em_bkno from uo_conno within w_qa_product_review_blind-03112010
end type
type dw_qa_prod_review from u_pics_dw within w_qa_product_review_blind-03112010
end type
type dw_qa_qastg from u_pics_dw within w_qa_product_review_blind-03112010
end type
type dw_qa_narr from u_pics_dw within w_qa_product_review_blind-03112010
end type
type cb_narr from u_cb within w_qa_product_review_blind-03112010
end type
type st_3 from statictext within w_qa_product_review_blind-03112010
end type
type dw_qa_recagcy from u_pics_dw within w_qa_product_review_blind-03112010
end type
type dw_qa_cntr from u_pics_dw within w_qa_product_review_blind-03112010
end type
end forward
...
global w_qa_product_review_blind-03112010 w_qa_product_review_blind-03112010
...
on w_qa_product_review_blind-03112010.create
int iCurrent
call super::create
...
on w_qa_product_review_blind-03112010.destroy
call super::destroy
