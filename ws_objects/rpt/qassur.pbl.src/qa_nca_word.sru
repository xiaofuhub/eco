$PBExportHeader$qa_nca_word.sru
$PBExportComments$Word Toolkit V1.0
forward
global type qa_nca_word from nonvisualobject
end type
end forward

global type qa_nca_word from nonvisualobject autoinstantiate
end type
...
on qa_nca_word.create
call super::create
TriggerEvent( this, "constructor" )
end on

on qa_nca_word.destroy
