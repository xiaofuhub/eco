$PBExportHeader$w_create_contract_type_back.srw
forward
global type w_create_contract_type_back from w_sheet
end type
type cb_exit from u_cb within w_create_contract_type_back
end type
type cb_clear from u_cb within w_create_contract_type_back
end type
type cb_update from u_cb within w_create_contract_type_back
end type
type st_1 from statictext within w_create_contract_type_back
end type
type st_2 from statictext within w_create_contract_type_back
end type
type em_cntrtype from uo_conno within w_create_contract_type_back
end type
type ddlb_cntrmed from dropdownlistbox within w_create_contract_type_back
end type
type dw_create_contract_type from u_pics_dw within w_create_contract_type_back
end type
type st_3 from statictext within w_create_contract_type_back
end type
type sle_cntrdesc from u_sle within w_create_contract_type_back
end type
end forward
...
global w_create_contract_type_back w_create_contract_type_back

type variables
string Lmed
end variables

on w_create_contract_type_back.create
int iCurrent
call super::create
...
on w_create_contract_type_back.destroy
call super::destroy
