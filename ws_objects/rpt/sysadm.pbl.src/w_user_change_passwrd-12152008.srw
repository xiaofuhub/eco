$PBExportHeader$w_user_change_passwrd-12152008.srw
forward
global type w_user_change_passwrd-12152008 from w_sheet
end type
type dw_user_change_password from u_dw within w_user_change_passwrd-12152008
end type
type cb_exit from u_cb within w_user_change_passwrd-12152008
end type
type cb_clear from u_cb within w_user_change_passwrd-12152008
end type
type cb_update from u_cb within w_user_change_passwrd-12152008
end type
end forward
...
global w_user_change_passwrd-12152008 w_user_change_passwrd-12152008
...
on w_user_change_passwrd-12152008.create
int iCurrent
call super::create
...
on w_user_change_passwrd-12152008.destroy
call super::destroy
...
//	this.object.passwrd[1]=""
	...
	this.object.new_passwrd[1]=""
	this.object.passwrd1[1]=""
	this.object.passwrd2[1]=""	
end if
...
IF DWO.Name = 'new_passwrd' THEN
	...
	lds2.sort()
       ...
       ld_passwordchg = date(lds2.object.passwrdchg[1])
	...
	IF RelativeDate(ld_passwordchg, 1) > ld_today AND ld_passwordchg <= ld_today THEN
		dw_user_change_password.object.passwrd.Validationmsg='Password failed.'+&
...
IF dw_user_change_password.Update() = 1 THEN
	...
	ELSE
		...
		VALUES(:ls_userid,:ls_old_password,:ldt_date)
		USING SqlServerTrans;
