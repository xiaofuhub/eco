$PBExportHeader$w_pcs_gets_date_s1.srw
forward
global type w_pcs_gets_date_s1 from w_response
end type
type cb_ok from u_cb within w_pcs_gets_date_s1
end type
type cb_cancel from u_cb within w_pcs_gets_date_s1
end type
type em_date from u_em within w_pcs_gets_date_s1
end type
type st_1 from u_st within w_pcs_gets_date_s1
end type
end forward
...
integer width = 873
integer height = 492
string title = "Check Reports"
cb_ok cb_ok
cb_cancel cb_cancel
em_date em_date
st_1 st_1
end type
global w_pcs_gets_date_s1 w_pcs_gets_date_s1

on w_pcs_gets_date_s1.create
int iCurrent
call super::create
...
ELSE
	...
	CloseWithReturn(w_pcs_gets_date_s1,string(ld_date,'mm/dd/yyyy'))
End If
end event
