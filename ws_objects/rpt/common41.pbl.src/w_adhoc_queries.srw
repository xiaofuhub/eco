...
//	ls_msg = 'C:\picsorcl9i\Winsql.exe -dpcsp -pnlsbph -upics3 ' + ls_file_location + '\' + '"' + ls_filename + '"'
	ls_msg = 'C:\picsorcl9i\winsql.exe -d' + ls_dbname + ' -p' + ls_logpass + ' -u' + ls_logid +  ' ' + ls_file_location + '\' + '"' + ls_filename + '"'
