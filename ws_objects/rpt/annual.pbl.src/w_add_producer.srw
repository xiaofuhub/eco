$PBExportHeader$w_add_producer.srw
$PBExportComments$Window to add/update producers
forward
global type w_add_producer from w_response
end type
type cb_exit from commandbutton within w_add_producer
end type
type cb_update from commandbutton within w_add_producer
end type
type dw_add_producer from u_pics_dw within w_add_producer
end type
type cb_find from commandbutton within w_add_producer
end type
type cb_clear from commandbutton within w_add_producer
end type
end forward
...
integer width = 2912
integer height = 1660
string title = "Add/Update Producer"
cb_exit cb_exit
cb_update cb_update
...
global w_add_producer w_add_producer

on w_add_producer.create
int iCurrent
call super::create
...
event clicked;dw_add_producer.ResetUpdate()
...
integer height = 1344
integer taborder = 10
string dataobject = "d_add_producer"
boolean vscrollbar = false
boolean livescroll = false
end type

event ue_enterkey;call super::ue_enterkey;IF (dw_add_producer.GetColumn() <> 1 ) THEN
...
dw_add_producer.of_SetTransObject(SQLServerTrans)
...
IF Lprdr <> "" THEN
	...
	ll_rows = dw_add_producer.Retrieve(Lprdr)
      ...
      rtn = MessageBox("Find Error", "Producer does not exist. Insert new record?" ,Question!, OkCancel!, 1)
		IF rtn=1 THEN
			...
			dw_add_producer.SetItem(dw_add_producer.GetRow(),"prdr",Lprdr)
			dw_add_producer.Object.prdr.TabSequence='0'
			dw_add_producer.Object.prdr_name.TabSequence='10'
			dw_add_producer.Object.prdr_addr.TabSequence='20'
			dw_add_producer.Object.prdr_city.TabSequence='30'
			dw_add_producer.Object.prdr_state.TabSequence='40'
			dw_add_producer.Object.prdr_zip.TabSequence='50'
			dw_add_producer.Object.vendorcd.TabSequence='70'
			dw_add_producer.Object.contact_name.TabSequence='80'
			dw_add_producer.Object.contact_phone.TabSequence='90'
			dw_add_producer.Object.contact_fax.TabSequence='100'
			dw_add_producer.Object.contact_email.TabSequence='110'
			dw_add_producer.Object.prdr_name.Edit.Required='Yes'
	...
	ELSE
		...
		dw_add_producer.Object.prdr_state.TabSequence='40'
		dw_add_producer.Object.prdr_zip.TabSequence='50'
		dw_add_producer.Object.vendorcd.TabSequence='60'
		dw_add_producer.Object.contact_name.TabSequence='70'
		dw_add_producer.Object.contact_phone.TabSequence='80'
		dw_add_producer.Object.contact_fax.TabSequence='90'
		dw_add_producer.Object.contact_email.TabSequence='100'
		w_add_producer.cb_clear.Enabled=TRUE
		w_add_producer.cb_update.Enabled=TRUE
		w_add_producer.cb_find.Enabled=FALSE		
  	...
  	END IF
ELSE
   MessageBox("Database Error", "Please enter the producer code." ,StopSign!, OK!, 2)
	dw_add_producer.setfocus()
END IF
...
dw_add_producer.Object.prdr_name.Edit.Required='No'
...
dw_add_producer.Object.prdr.TabSequence='10'
