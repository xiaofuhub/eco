$PBExportHeader$w_cds_gets_chno.srw
forward
global type w_cds_gets_chno from w_response
end type
type cb_ok from u_cb within w_cds_gets_chno
end type
type cb_cancel from u_cb within w_cds_gets_chno
end type
type em_chno from u_em within w_cds_gets_chno
end type
type st_1 from u_st within w_cds_gets_chno
end type
end forward
...
string Title="Edit Annotations Report"
cb_ok cb_ok
cb_cancel cb_cancel
em_chno em_chno
st_1 st_1
end type
global w_cds_gets_chno w_cds_gets_chno

on w_cds_gets_chno.create
int iCurrent
...
ELSE
	...
	CloseWithReturn(w_cds_gets_chno,Lchart_no)
END IF
