$PBExportHeader$w_eco_patron_amplifier_only.srw
forward
global type w_eco_patron_amplifier_only from w_main
end type
type cb_exit from u_cb within w_eco_patron_amplifier_only
end type
type cb_update from u_cb within w_eco_patron_amplifier_only
end type
type cb_delete from u_cb within w_eco_patron_amplifier_only
end type
type cb_clear from u_cb within w_eco_patron_amplifier_only
end type
type cb_find from u_cb within w_eco_patron_amplifier_only
end type
type cb_summary from commandbutton within w_eco_patron_amplifier_only
end type
type dw_eco_units from u_dw within w_eco_patron_amplifier_only
end type
type dw_eco_patron_sum from u_dw within w_eco_patron_amplifier_only
end type
type st_1 from statictext within w_eco_patron_amplifier_only
end type
type sle_rows from singlelineedit within w_eco_patron_amplifier_only
end type
type dw_eco_patron from u_dw within w_eco_patron_amplifier_only
end type
end forward
...
global w_eco_patron_amplifier_only w_eco_patron_amplifier_only

type variables
boolean rows_exist=FALSE
end variables

on w_eco_patron_amplifier_only.create
int iCurrent
call super::create
...
on w_eco_patron_amplifier_only.destroy
call super::destroy
...
integer taborder = 20
boolean bringtotop = true
string dataobject = "d_eco_units_amplifier_only"
end type
...
integer height = 944
integer taborder = 10
string dataobject = "d_eco_patron_amplifier_only"
end type
